package io.github.slawomirr.taskswithangularjs;
...
public class TasksWithAngularjsApplication {

    public static void main(String[] args) {
        SpringApplication.run(TasksWithAngularjsApplication.class, args);
    }
